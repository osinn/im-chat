...
function initWs () {
 myname = document.getElementById("username").value; //getRandomName();
 var token = document.getElementById("token").value; //getRandomName();
  var queryString = 'name='+myname + "&token=" + token;
